...
?>
  ...
  <div class="container border-top pt-5">
    <footer class="flex-wrap align-items-center">
      <article class="row">
        <a class="nav-link link-dark col-md d-flex align-items-start justify-content-center" href="https://discord.gg/GzzHccRQpU">
        ...
        <a class="nav-link link-dark col-md d-flex align-items-start justify-content-center" href="/">
