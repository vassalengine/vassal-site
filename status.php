...
<body>
  ...
  <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between px-2 py-2">
    ...
    <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      ...
      <li>
        <a class="nav-link px-2 link-dark" href="https://forum.vassalengine.org/t/what-to-do-about-a-chat-server/72147"><svg class="svg-icon"><use xlink:href="#fab-discord"></use></svg> Chat</a>
      </li>
  ...
  <div id="alert-bar" class="text-center">
    <h5 class="py-3">We've upgraded our site! See the <a class="link-light" href="https://forum.vassalengine.org/t/site-upgrade-complete/72146">news</a> for details.</h5>
  </div>
  ...
  <div class="container border-top pt-5">
    <footer class="flex-wrap align-items-center">
      <article class="row">
          ...
          <a class="nav-link link-dark col d-flex align-items-start" href="https://forum.vassalengine.org/t/what-to-do-about-a-chat-server/72147">
          ...
          <a class="nav-link link-dark col d-flex align-items-start" href="https://github.com/vassalengine/vassal">
          ...
          <a class="nav-link link-dark col d-flex align-items-start" href="/">
            <img class="footer-icon float-start mx-2" src="/images/newspaper-folded-svgrepo-com.svg" width="442" height="442" alt="">
            <div>
              <h5 class="mb-0">The Vassal Blog</h5>
              <p>There's not one yet</p>
            </div>
          </a>
      ...
      <div id="colophon" class="text-center pt-5">
        <div class="row text-muted">
          <p class="col mb-0">Copyright © 2009–2021 The Vassal Team</p>
        </div>
        <div class="row text-muted">
          <p class="col">
