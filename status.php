...
<body>
  ...
  <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between px-2 py-2">
    ...
    <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      ...
      <li><a class="nav-link px-2 link-dark" href="/library/projects"><svg class="svg-icon"><use xlink:href="#chess-knight"></use></svg> Modules</a></li>
  ...
  <div id="alert-bar" class="text-center">
    <h5 class="py-3">Vassal 3.7.20 is released! See the <a class="link-light" href="https://forum.vassalengine.org/t/vassal-3-7-20-released/89864">news</a> for details.</h5>
  </div>
    ...
    <footer class="flex-wrap align-items-center">
      ...
      <div id="colophon" class="text-center pt-5">
        <div class="row text-muted">
          <p class="col mb-0">Copyright © 2009–2026 The Vassal Team</p>
        </div>
        <div class="row text-muted">
          <p class="col">
