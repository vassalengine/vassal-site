...
<body>
  ...
  <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between px-2 py-2">
    ...
    <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      ...
      <li>
        <a class="nav-link px-2 link-dark" href="https://discord.gg/GzzHccRQpU"><svg class="svg-icon"><use xlink:href="#fab-discord"></use></svg> Chat</a>
      </li>
  ...
  <div id="alert-bar" class="text-center">
    <h5 class="py-3">Vassal 3.6.2 is released! See the <a class="link-light" href="https://forum.vassalengine.org/t/vassal-3-6-2-released/73276">news</a> for details.</h5>
  </div>
  ...
  <div class="container border-top pt-5">
    <footer class="flex-wrap align-items-center">
      <article class="row">
          ...
          <a class="nav-link link-dark col d-flex align-items-start" href="https://discord.gg/GzzHccRQpU">
